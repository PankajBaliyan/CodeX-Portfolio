            ...
            class NestedTabs extends i.default {
                ...
                getHeadingEvents() {
                    return {
                        ...
                        mousemove:
                            this.setHorizontalTabTitleScrollValues.bind(this),
                    };
                }
                bindEvents() {
                ...
                changeFocusFromActiveTabTitleToContentContainer(e) {
                    const t = 'Tab' === this.getKeyPressed(e),
                        n =
                            this.getFocusableItemsInsideActiveContentContainer()[0],
                        r =
                ...
                itemInsideContentContainerHasFocus(e) {
                    const t =
                            elementorFrontend.elements.window.document
                                .activeElement,
                        n =
                            this.getFocusableItemsInsideActiveContentContainer();
                ...
                changeScrollStatus(e) {
                    ...
                    'mousedown' === e.type
                        ? (t.classList.add('e-scroll'),
                          (t.dataset.pageX = e.pageX))
                ...
                ('__proto__' in {}
                    ? (function () {
                          ...
                          return function setPrototypeOf(n, r) {
                              return (
                                  i(n), s(r), t ? e(n, r) : (n.__proto__ = r), n
                              );
                          };
                      })()
                    : void 0);
                ...
                if (w) {
                    ...
                    if (
                        ...
                        'Error' !== S
                            ...
                            : p &&
                              v in w &&
                              (c(E, w, v), c(E, w, 'prepareStackTrace')),
                        l(E, w),
                        !f)
                    )
                        try {
